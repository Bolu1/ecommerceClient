        ...
        <section class="max-w-4xl mt-5 p-6 mx-auto bg-white rounded-md shadow-md :bg-gray-800">
          ...
          <form>
            <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
              ...
              <div>
                <label class="text-gray-700 :text-gray-200" for="text">
                  Category
                </label>
                <input
                  required
            ...
            <div class="flex justify-end mt-6">
              <button onClick={submitHandler} class="px-6 py-2 leading-5 text-white transition-colors duration-200 transform bg-indigo-700 rounded-md hover:bg-indigo-600 focus:outline-none focus:bg-indigo-600">
                Save
              </button>
            </div>
          </form>
