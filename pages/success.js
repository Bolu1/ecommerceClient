  ...
  return (
    <div style={{ minHeight: "100vh" }} className="flex">
      <div style={{ marginTop: "40vh" }} className="mx-auto ">
        <div className="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-md :bg-gray-800">
          ...
          <div className="px-4 py-2 -mx-3">
            <div className="mx-3">
              <span className="font-semibold text-emerald-500 :text-emerald-400">
                Success
              </span>
