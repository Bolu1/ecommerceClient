  ...
  return (
          ...
          <div className="container grid grid-cols-1 gap-6 mx-auto sm:grid-cols-2 xl:grid-cols-4">
            <div className="flex p-4 space-x-4 rounded-lg md:space-x-6 :bg-coolGray-900 :text-coolGray-100">
              <div className="flex justify-center p-2 align-middle rounded-lg sm:p-4 :bg-violet-400">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor" className="h-9 w-9 :text-coolGray-800">
	...
	<div className="container mx-auto space-y-12">
		<div className="flex flex-col overflow-hidden rounded-md shadow-sm lg:flex-row">
			<img src="https://source.unsplash.com/640x480/?1" alt="" className="h-80 :bg-coolGray-500 aspect-video"/>
			<div className="flex flex-col justify-center flex-1 p-6 :bg-coolGray-900">
				<span className="text-xs uppercase :text-coolGray-400">We The Best </span>
				<h3 className="text-3xl font-bold">Get The Best From The Best</h3>
				<p className="my-6 :text-coolGray-400">Ecommerce Stuff Has The Best Products In The World, Get The Best From The Best</p>
      ...
      <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20 :bg-coolGray-800 :text-coolGray-100">
        ...
        <ul className="grid gap-3 md:grid-cols-2 lg:grid-cols-3">
          <li className="flex items-center space-x-2">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 fillCurrent :text-violet-400">
