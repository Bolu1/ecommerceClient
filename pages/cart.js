...
function CartScreen() {
    ...
    return (
        <Layout title="My cart">
            ...
            {cart.cartItems.length === 0 ? (<div className=" text-center p-10  text-2xl " style={{marginTop:"25vh"}}>
                WOW!! Your bag is empty lets <Link href="/" className="text-indigo-600"><p className="text-indigo-600 cursor-pointer">go shopping</p></Link> 
            </div>): (
                ...
                <div className="h-full w-full flex flex-col bg-white shadow-xl overflow-y-scroll">
                            ...
                            <li key={product.id} className="py-6 flex " >
                              ...
                              <div className="ml-4 flex-1 flex flex-col">
                                ...
                                <div className="flex-1 flex items-end justify-between text-sm">
                                    ...
                                    <p >Qty </p>
                                    {/* {console.log(amount)} */}
                                  <input className="text-gray-500 ml-1 border rounded-sm text-center w-10" id="quantity" name="quantity" type="number" min="1" max={qty} value={product.quantity} onChange={(e) => updateCart(product, e.target.value)}/>
                                  </div>
                                  <div className="flex">
                  ...
                  <div className="border-t border-gray-200 py-6 px-4 sm:px-6">
                    <div className="flex justify-between text-base font-medium text-gray-900">
                      ...
                      <p>Subtotal ({cart.cartItems.reduce((a,c) => a + c.quantity, 0)}{' '} item(s))</p>
                      <p>${cart.cartItems.reduce((a,c) => a + c.quantity * c.price, 0)}</p>
                    </div>
